package ee.ut.dsg.jasper.sds;

import ee.ut.dsg.jasper.engine.Jasper;
import ee.ut.dsg.jasper.engine.esper.EsperStreamRegistrationService;
import ee.ut.dsg.jasper.execution.ContinuousQueryExecutionFactory;
import ee.ut.dsg.jasper.execution.JenaContinuousQueryExecution;
import ee.ut.dsg.jasper.operators.s2r.EsperWindowOperator;
import ee.ut.dsg.jasper.querying.Entailment;
import ee.ut.dsg.jasper.querying.syntax.RSPQLJenaQuery;
import ee.ut.dsg.jasper.streams.EPLRDFStream;
...
public class JasperSDSManager implements SDSManager {
    ...
    public SDS build() {
        ...
        Map<String, WebDataStream> registeredStreams = stream_registration_service.getRegisteredStreams();
