...
import ee.ut.dsg.jasper.secret.report.EsperNECReportStrategy;
...
@Log4j
public abstract class EsperRSPEngine2 implements StreamRegistrationFeature<EPLPGraphStream, WebStream>, StreamDeletionFeature<EPLRDFStream>, QueryDeletionFeature {
    ...
    public EsperRSPEngine2(long t0, EngineConfiguration configuration) {
    ...
    @Override
    public EPLPGraphStream register(WebStream s) {
        return (EPLPGraphStream) stream_registration_service.register(s);
    }
